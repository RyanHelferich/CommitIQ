        ...
        <div className="rubric-item">
          ...
          <table className="judge-table">
            <tbody>
              ...
              <tr><td>Smallest wedge</td><td>A privacy-safe relationship review report for one conversation. It creates value for a dater, coach, or educator before CommitIQ needs real dating-platform integrations.</td></tr>
        ...
        <div className="rubric-item">
          ...
          <table className="judge-table">
            <tbody>
              ...
              <tr><td>Repository evidence</td><td>Attach the public repository URL in the submission form so judges can verify implementation depth. This is the main remaining technical-score gap.</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="rubric-item">
          ...
          <table className="judge-table">
            <tbody>
              ...
              <tr><td>Why it gets bigger</td><td>The initial coach/user report wedge expands into paid coach dashboards, longitudinal relationship check-ins, opt-in dating platform safety/compatibility features, and a labeled compatibility-pattern dataset.</td></tr>
